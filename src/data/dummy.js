...
import { AiOutlineCalendar, AiOutlineShoppingCart, AiOutlineAreaChart, AiOutlineBarChart, AiOutlineStock, AiFillHome, AiFillDatabase, AiFillBank } from 'react-icons/ai';
import { FiShoppingBag, FiEdit, FiPieChart, FiBarChart, FiCreditCard, FiStar, FiShoppingCart, FiHome, FiUser, FiUsers, FiUserX } from 'react-icons/fi';
import { BsKanban, BsBarChart, BsBoxSeam, BsCurrencyDollar, BsShield, BsChatLeft, BsFillLayersFill, BsFillMenuButtonWideFill, BsFillCartFill, BsFillPersonFill, BsMessenger } from 'react-icons/bs';
...
export const links = [
    ...
    links: [
      {
        ...
        url: 'admin/manages-category'
      },
      {
        name: 'Quản lý NSX',
        icon: <AiFillBank />,
        url: 'admin/manages-producer'
      },
      {
        name: 'Quản lý sản phẩm',
        icon: <BsFillLayersFill />,
        url: 'admin/manages-product'
      },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      {
        name: 'Thống kế sản phẩm',
        icon: <AiOutlineStock />,
        url: 'admin/dashboard-product'
      },
      {
        name: 'Thống kế đơn hàng',
  ...
  },
  {
    ...
    links: [
      {
        name: 'Quản lý người quản trị',
        icon: <IoMdContacts />,
        url: 'admin/manages-users'
      },
      {
        name: 'Quản lý khách hàng',
        icon: <FiUsers />,
        url: 'admin/manages-customers'
      },
    ],
  },
];
...
export const categoryColumGrid = [
  {
    field: 'no',
    headerText: 'STT',
    width: '60',
...
export const producerColumGrid = [
  {
    field: 'no',
    headerText: 'STT',
    width: '60',
