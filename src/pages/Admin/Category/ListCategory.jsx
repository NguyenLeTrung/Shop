...
import { contextMenuItems, categoryColumGrid, dataCategory } from '../../../data/dummy';
import { Button, Footer, Header, Navbar, Sidebar, ThemeSettings } from '../../../components/Admin';
import "../Admin.css";
                        ...
                        <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl">
                            ...
                            >
                                <ColumnsDirective>
                                    ...
                                    {categoryColumGrid.map((item, index) => (
